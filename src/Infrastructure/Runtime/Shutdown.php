...
/*
use function {
    defined, error_reporting, is_callable, register_shutdown_function,
    call_user_func, exit, file_exists, parse_ini_file, file_put_contents,
    hash_file, is_file, filesize, array_filter, array_replace, is_bool,
    is_null, is_numeric, is_string, preg_match, preg_replace, json_decode,
    trim, str_starts_with, str_ends_with, hash, file_get_contents, implode,
    error_log, error_get_last, is_array, random_bytes, bin2hex,
};

use const { 
  E_ERROR, E_PARSE, E_CORE_ERROR,
  E_COMPILE_ERROR, INI_SCANNER_TYPED,
  FILE_APPEND;
};
*/
...
final class Shutdown
{
    ...
    private static function backupEnvFile(string $filePath): void
    {
        ...
        \file_put_contents("$filePath.example", $backupContent);
    }
