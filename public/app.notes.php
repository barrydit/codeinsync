...
<body>
  <div style="position: relative;">
    <div id="add_new"
      style="position: fixed; display: none; top: 25px; left: 50%; transform: translateX(-50%); width: 725px; padding: 5px; border: 1px solid #000; background-color: #fff; z-index: 1;">
      <form action method="POST">
        ...
        <div style=" width: 725px;">
          <div style="display: inline-block;">Category: <!-- use datalist instead -->
            ...
            <label for="title">Title: </label><input id="title" type="text" style="width: 390px;" name="title"
              value="" /><br />
            <label for="so-url">Stackoverflow: </label><input id="so-url" type="text" name="so-url"
              style="width: 300px;" value="" /><br />
          </div>

          <div style="display: inline-block; text-align: right; float: right; clear: both;">[<a href="#"
              id="close_add_new">X</a>]<br />
        ...
        <textarea id="description" rows="5" style="width: 100%;" <?= /* cols="100" */ NULL; ?> name="description"
          spellcheck="false"></textarea><br />
        <label for="inputval">Source Code: </label><br />
        <textarea id="inputval" rows="15" style="width: 100%;" <?= /* cols="100" */ NULL; ?> name="inputval"
          spellcheck="false"></textarea><br />
      </form>
    ...
    foreach ($sample['snippets'] as $key2 => $snippet) {
      ...
      <form action method="POST">
        ...
        <div style="display: inline-block; font-size: 18px; margin-top: 0px; padding-bottom: 5px;">
          <button type="submit" class="move_up" name="n_id" value="<?= $key1 . '-' . (empty($key2) ? $key2 : $key2 - 1); ?>"
            style="<?= ($counter == 0 ? 'visibility: hidden;' : '') /* NULL; */ ?>" onchange="this.form.submit();"></button>
          <button type="submit" class="move_down" name="n_id" value="<?= $key1 . '-' . $key2 + 1; ?>"
