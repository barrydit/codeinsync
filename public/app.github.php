...
<div id="app_github-container"
  class="<?= (APP_SELF == __FILE__ || (isset($_GET['app']) && $_GET['app'] == 'github') ? 'selected' : '') ?>"
  ...
  <div class="header ui-widget-header">
    ...
    <div style="display: inline; float: right; text-align: center;">[<a style="cursor: pointer; font-size: 13px;"
        onclick="document.getElementById('app_github-container').style.display='none';">X</a>]</div>
  </div>
