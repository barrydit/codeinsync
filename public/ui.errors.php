...
<div id="app_errors-container"
    ...
    <div class="ui-widget-header"
        ...
        <div style="display: inline; float: right; text-align: center; color: blue;"><code
                style="background-color: white; color: #0078D7;"><a style="cursor: pointer; font-size: 13px;" onclick="document.getElementById('app_errors-container').style.display='none';">[X]</a></code>
        </div>
    </div>
            ...
            <div style="display: inline-block; text-align: left; width: 300px;">
                ...
                <div class="text-xs" style="display: inline-block; border: 1px solid #000;">
                    <a class="text-sm" id="app_errors-frameMenuPrev"
                        ...
                        &lt; Menu</a> | <a class="text-sm" id="app_errors-frameMenuNext"
...
*/ NULL; ?>
        ...
        <div style="position: relative; margin: 0 auto; width: calc(100% - 2px); height: 100%;">
            <!--
      <div id="app_errors-frameMenu" class="app_errors-frame-container absolute selected" style="background-color: rgb(225,196,151,.75); margin-top: 8px; height: 100%;">
-->
...
<div id="app_errors-frameInit" class="app_errors-frame-container absolute" style="overflow: hidden; height: 270px;">
    <!--
