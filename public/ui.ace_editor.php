...
<div id="app_ace_editor-container"
  ...
  <div class="ui-widget-header"
    ...
    <div style="display: inline; float: right; text-align: center; color: blue;"><code
        style="background-color: white; color: #0078D7;"><a style="cursor: pointer; font-size: 13px;" onclick="document.getElementById('app_ace_editor-container').style.display='none';">[X]</a></code>
    </div>
  </div>
    ...
    <div class="ui-widget-content"
      ...
      <div style="display: inline-block; text-align: left; width: 125px;">
        ...
        <div class="text-xs" style="display: inline-block; border: 1px solid #000;">
          <a class="text-sm" id="app_ace_editor-frameMenuPrev"
            href="<?= (!empty(APP_QUERY) ? '?' . http_build_query(APP_QUERY) : '') . (defined('APP_ENV') && APP_ENV == 'development' ? '#!' : '#') ?>">
            &lt; Menu</a> | <a class="text-sm" id="app_ace_editor-frameMenuNext"
...
<div id="app_ace_editor-frameInit" class="app_ace_editor-frame-container absolute"
