    ...
    <div class="developer-group" id="devGroup">
      ...
      <div class="top-panel" id="top-panel">
        <div style="position: relative;">
          <a href="#"><img src="assets/images/phpclasses_icon.png" alt="Logo"
          ...
          <a href="#" data-open-app="tools/registry/composer" aria-label="Open Composer" title="Composer"><img
              src="assets/images/composer_icon.png" alt="Logo" style="width: 31px; height: auto; margin: 0 5px;"
              onclick="/*openApp('tools/registry/composer');*/"></a>
          <a href="#"><img src="assets/images/packagist_icon.png" alt="Logo"
              style="width: 31px; height: auto; margin: 0 5px;"
          ...
          <a href="#" data-open-app="tools/code/git" aria-label="Open Git" title="Git"><img
              src="assets/images/git_icon.fw.png" width="32" height="32"
              onclick="/*openApp('tools/code/git');*/"></a>
          <a href="#"><img src="assets/images/node_js.gif" alt="Logo"
          ...
          <a href="#"><img src="assets/images/npm_icon.png" alt="Logo"
          ...
          <a href="#"><img src="assets/images/console_icon.png" alt="Logo"
              style="width: 31px; height: auto; margin: 0 5px;"
          ...
          <a href="#" style="margin: 5px 0 0 0;"
            ...
            <img src="assets/images/apps_icon.gif" style="margin: -5px 0 0 0;" width="20" height="20"> <span
              style="margin-top: -5px;">Tools</span></a>
        </div>
        <div style="position: absolute; top: 5px; right: 270px;">
          <img src="assets/images/php_icon.png" alt="Logo" style="width: 31px; height: auto; margin: 0 0;"
        ...
        <div
          ...
          <div style="position: relative; top: 0; display: inline-block; width: auto; ">
            <img id="ts-status-light" style="padding-bottom: 10px; cursor: pointer;"
              src="assets/images/timesheet-light-Y.gif" width="80" height="30">
          </div>
      ...
      <div
        ...
        <div style="position: absolute; margin: 10px 75px; text-align: center;" class="text-sm"><a href="#!"
            onclick="isFixed = true; show_console(); return false;"><img style="text-align: center;"
              src="assets/images/cli.png"></a><br><a href="?app=ace_editor&amp;path=&amp;file=app.console.php"
        ...
        <div style="position: absolute; margin: 10px 165px; text-align: center;" class="text-sm"><a href="#"
            target="_blank" onclick="toggleIframeUrl('app.whiteboard.php'); return false;"><img
              style="text-align: center;" src="assets/images/whiteboard.png"></a><br><a
        ...
        <div style="position: absolute; margin: 10px 350px; text-align: center;" class="text-sm">
          <a href="#!"
            ...
            <img style="text-align: center;" src="assets/images/project.png"></a><br><a
        ...
        <div style="position: absolute; margin: 10px 0 0 630px; text-align: center;" class="text-sm"><a href="#!"
            onclick="toggleIframeUrl('app.browser.php'); return false;"><img style="text-align: center;"
              src="assets/images/browser.png"><br><span style="text-align: center;">Browser</span></a></div>
        ...
        <div style=" position: absolute; margin: 110px 0 0 540px; text-align: center;" class="text-sm"><a href="#!"
            onclick="toggleIframeUrl('pong.php'); return false;"><img style="text-align: center;"
              src="assets/images/pong.png"><br><span style="text-align: center;">Pong</span></a>
        </div>
        ...
        <div style="position: absolute; margin: 210px 160px; text-align: center;" class="text-sm"><a href="#!"
            onclick="document.getElementById('app_browser-container').style.display='block'; return false;"><img
              style="text-align: center;" src="assets/images/stackoverflow.png"><br><span
        ...
        <div style="position: absolute; margin: 210px 340px; text-align: center;" class="text-sm"><a href="#!"
            onclick="document.getElementById('app_browser-container').style.display='block'; return false;"><img
              style="text-align: center;" src="assets/images/w3c.png"><br><span style="text-align: center;">W3C
              Validator</span></a></div>
        <!-- https://tailwindcss.com/docs/ // -->
        <div style="position: absolute; margin: 210px 0 0 445px; text-align: center;" class="text-sm"><a href="#!"
            onclick="document.getElementById('app_browser-container').style.display='block'; return false;"><img
              style="text-align: center;" src="assets/images/tailwindcss.png"><br><span
        ...
        <div style="position: absolute; margin: 210px 0 0 540px; text-align: center;" class="text-sm"><a href="#!"
            onclick="document.getElementById('app_browser-container').style.display='block'; return false;"><img
              style="text-align: center;" src="assets/images/php.png"><br><span style="text-align: center;">PHP
              Docs</span></a></div>
        <!-- https://dev.mysql.com/doc/ // -->
        <div class="text-sm" style="position: absolute; margin: 210px 0 0 615px; text-align: center;"><a href="#!"
            onclick="document.getElementById('app_browser-container').style.display='block'; return false;"><img
              style="text-align: center;" src="assets/images/mysql.png"><br><span style="text-align: center;">MySQL
              Docs</span></a></div>
        <div
...
<?= dd(APP_PATH . APP_ROOT . APP_ROOT_DIR, false); ?>
  ...
  <script
    src="<?= APP_IS_ONLINE && check_http_status('https://code.jquery.com/jquery-3.7.1.min.js') ? 'https://code.jquery.com/jquery-3.7.1.min.js' : app_base('public', null, 'rel') . 'assets/vendor/jquery/' . 'jquery-3.7.1.min.js' ?>"></script>

  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js"></script>
  <!-- You need to include jQueryUI for the extended easing options. -->
  <!-- script src="//code.jquery.com/jquery-1.12.4.js"></script -->
  <?php
  if (!is_file($path = app_base('public', null, 'abs') . 'assets/vendor/jquery/' . 'jquery-ui-1.12.1.js') || ceil(abs((strtotime(date('Y-m-d')) - strtotime(date('Y-m-d', strtotime('+5 days', filemtime($path))))) / 86400)) <= 0) {
  ...
  <script
    src="<?= APP_IS_ONLINE && check_http_status('https://code.jquery.com/ui/1.12.1/jquery-ui.min.js') ? 'https://code.jquery.com/ui/1.12.1/jquery-ui.min.js' : app_base('public', null, 'rel') . 'assets/vendor/jquery/' . 'jquery-ui-1.12.1.js' ?>"></script>
